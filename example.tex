...
\degreeprogram{Physics and Applied Physics}
...
%% Other settings you may need to change for the title page:
% \defensedate{}                  % Default: set by \date
% \graddate{}                     % Default: set by \date
